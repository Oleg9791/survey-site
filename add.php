...
if (empty($_POST["name"] or $_POST["name"] = "") or empty($_POST["login"] or $_POST["login"] = "")
    ...
    echo "<button style='margin: 100px 0px 0px 680px; height: 40px; background-color: green; text-align: center;' ><a style='text-decoration: none; color: aliceblue'  href='main.html' class='btn btn-success'>Пройти регистрацию заново</a></button>";
    die();
}
$name = $_POST["name"];
$login = $_POST["login"];
